...
<head>
  ...
  <title>Logout | myITS Fitness</title>

  {{-- FEATURE: Tailwind CSS for responsive design --}}
  <script src="https://cdn.tailwindcss.com"></script>

  {{-- FEATURE: Poppins font for consistent typography --}}
...
<body class="bg-[#f7f9fc] text-slate-800">
  ...
  {{-- FEATURE: Universal topbar with logout functionality for all user roles --}}
  <header class="flex justify-between items-center bg-white border-b px-6 py-3">
    ...
    <div class="flex items-center gap-4 relative">
      ...
      {{-- FEATURE: User menu button for all user types --}}
      ...
      {{-- FEATURE: Universal logout overlay component --}}
  ...
  {{-- FEATURE: Toggle logout overlay functionality --}}
  <script>
    const btn = document.getElementById('userMenuBtn');
    const overlay = document.getElementById('logoutOverlay');
    
    // FEATURE: Click outside to close logout overlay
    ...
    // FEATURE: Escape key to close overlay
