              ...
              <div class="p-6">
                ...
                <div class="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <!-- FEATURE: SKEM points badge - currently hard-coded as "SKEM 4" (static demo) -->
                    <span class="inline-flex items-center gap-2 h-10 px-3 rounded-lg bg-white border shadow-sm text-slate-800 font-semibold">
                      ...
                      <!-- FEATURE: Hard-coded SKEM value - needs dynamic generation based on accepted submissions -->
                      <span>SKEM 4</span>
                    </span>
                  </div>
                </div>
